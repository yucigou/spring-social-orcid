...
public interface ScopePaths {
     ...
     * This is why there is not a <CODE>set</CODE> method for the scopePaths property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getScopePaths().add(newItem);
     * </pre>
     * 
     * 
     * <p>
