...
public interface OrcidWorks {
     ...
     * This is why there is not a <CODE>set</CODE> method for the orcidWorks property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrcidWorks().add(newItem);
     * </pre>
     * 
     * 
     * <p>
